...
import { GameSelectInput } from './Form/GameSelectInput';
...
export const CreateAdModal = () => {
  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content 
        className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480] shadow-lg shadow-black/25'
      >
